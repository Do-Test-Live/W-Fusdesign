        ...
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button"
                                                 ...
                                                 aria-expanded="false">Language <i class="ti-angle-down"></i></a>
                    <ul class="dropdown-menu">
                        <li><a href="#" class="dropdown-item"><span>EN</span></a></li>
                        <li><a href="#" class="dropdown-item"><span>简体中文</span></a></li>
                        <li><a href="#" class="dropdown-item"><span>繁</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="footer-column footer-contact">
                        <h3 class="footer-title">ANGUS Lau</h3>
                        <p class="footer-contact-text">
                            Flat G, 9/F., Phase 2, Kingsford Ind., Bldg., <br/>
                            26-32 Kwai Hei St., Kwai Chung, N.Τ.
                        </p>
                        <div class="footer-contact-info">
                            <p class="footer-contact-phone">
                                <span class="flaticon-call"></span> +852 2492 5788
                            </p>
                            <p class="footer-contact-phone">
                                <span class="flaticon-phone"></span> +852 6114 8024
                            </p>
                            <p class="footer-contact-phone">
                                <span class="flaticon-message"></span> +852 2492 8518
                            </p>
                            <p class="footer-contact-mail">angus@fusdesign.com</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="footer-column footer-contact">
                        <h3 class="footer-title">CINCAL Szeto</h3>
                        <p class="footer-contact-text">
                            Flat G, 9/F., Phase 2, Kingsford Ind., Bldg., <br/>
                            26-32 Kwai Hei St., Kwai Chung, N.T.
                        </p>
                        <div class="footer-contact-info">
                            <p class="footer-contact-phone">
                                <span class="flaticon-call"></span> +852 2257 4968
                            </p>
                            <p class="footer-contact-phone">
                                <span class="flaticon-phone"></span> +852 9768 6371
                            </p>
                            <p class="footer-contact-phone">
                                <span class="flaticon-message"></span> +852 2492 8518
                            </p>
                            <p class="footer-contact-mail">cincal@fusdesign.com</p>
                        </div>
                    </div>
                </div>
            </div>
